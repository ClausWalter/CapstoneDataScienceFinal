...
## Creating the necessary data for unstemming using 2-gram-data
        matrixUnstemmed1<-as.matrix(tdm(corpusUnstemmed,1))
        write.table(matrixUnstemmed1, file="C:/Users/claus/Documents/Capstone/DataScienceCapstone/unstemming/unstemming2.csv", sep=";", col.names=TRUE)
        matrixUnstemmed2<-as.matrix(tdm(corpusUnstemmed,2))
        write.table(matrixUnstemmed2, file="C:/Users/claus/Documents/Capstone/DataScienceCapstone/unstemming/unstemming1.csv", sep=";", col.names=TRUE)
