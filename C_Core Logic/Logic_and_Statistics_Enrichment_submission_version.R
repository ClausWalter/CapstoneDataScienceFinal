...
## Preparation:
        ## Load n-grams
        dfNgram2<-read.csv(file="matrix2cleansed.csv", header=TRUE, sep = ",")
        dfNgram3<-read.csv(file="matrix3cleansed.csv", header=TRUE, sep = ",")
        dfNgram4<-read.csv(file="matrix4cleansed.csv", header=TRUE, sep = ",")
        dfNgram5<-read.csv(file="matrix5cleansed.csv", header=TRUE, sep = ",")
        ## Load unstemming and punctuation tables
        dfUnstem<-read.csv(file="matrix1unstemmingCleansed.csv", header=TRUE, sep = ",")
        dfPunctuation<-read.csv(file="matrixPunctuationCleansed.csv", header=TRUE, sep = ";")
        ...
        dfNgram2Personal<-read.csv(file="matrixTdm2Personal.csv", header=TRUE, sep = ";")
        dfNgram3Personal<-read.csv(file="matrixTdm3Personal.csv", header=TRUE, sep = ";")
        dfNgram4Personal<-read.csv(file="matrixTdm4Personal.csv", header=TRUE, sep = ";")
        dfNgram5Personal<-read.csv(file="matrixTdm5Personal.csv", header=TRUE, sep = ";")
## Input evaluation
